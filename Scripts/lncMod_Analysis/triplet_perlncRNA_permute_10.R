...
#Expression matrix
load("/home/modia/Apexa/TFTarget_JASPAR/PanTarget_Promoter_Motifs_112119/PanTarget_TotalGeneExpression_Cutoff_112119.rda")

#Significant TF-Target gene pairs
load(paste("../linReg_Run_Nov2019/",cancer,"_TFTarget_LinReg_Combined_112119.rda",sep=""))
...
cancer.cor$Top_padj = p.adjust(cancer.cor$Top_pval,method="hochberg")
cancer.cor$Bottom_padj = p.adjust(cancer.cor$Bottom_pval,method="hochberg")
...
save(cancer.cor.emp.sig,file=paste("./",cancer,"/",lncs,"_",cancer,"_Triplet_Permutated_Spear_112119.rda",sep=""))
